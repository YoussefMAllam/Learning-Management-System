...
--complete task--
update todo set done=1 where StID=202200286
...
--Student Assignments--
select assignment.Aname, assignment.due_date from assignment
where assignment.ccode='PHcode' and assignment.Aname not in (select assignment_submissions.Aname from assignment_submissions where StID='PHID')
and assignment.ccode not in (select assignment_submissions.ccode from assignment_submissions where StID='PHID') 
and assignment.sem not in (select assignment_submissions.sem from assignment_submissions where StID='PHID')
...
--Student Exam--
select course_data.cname,exam.venue,exam.exam_date from registered
...
--Get Announcements--
select announcements.title, announcements.content from announcements
where ccode='PHcode' and sem='PHsem'
------------------------Teacher Queries-----------------------
--Get Name--

use LMS2
insert into student(ID,Sname,Major,batch,email)
values
(202200286,'Youssef Allam','CIE',2022,'s-youssef.allam@zewailcity.edu.eg'),
(202200438,'Mohammad Mahmoud','CIE',2022,'s-mohammad.elrahman@zewailcity.edu.eg'),
(202200126,'Aml Tarek','CIE',2022,'s-aml.ismail@zewailcity.edu.eg'),
(202200102,'Ali Ehab','NANENG',2022,'s-ali.aziz@zewailcity.edu.eg'),
(202200603,'Mustafa Mahmoud','PEU',2022,'s-mustafa.elsayed@zewailcity.edu.eg'),
(202100184,'Thomas Emad','PEU',2021,'s-thomas.fawzy@zewailcity.edu.eg'),
(202200477,'Ahmed Yasser','CIE',2022,'s-ahmed.kadah@zewailcity.edu.eg'),
(202201027,'Ziad Haitham','CIE',2022,'s-ziad.fahmy@zewailcity.edu.eg'),
(202200647,'Ziad Reda','CIE',2022,'s-ziad.elsadek@zewailcity.edu.eg'),
(202200050,'Marwan Amr','REE',2022,'s-marwan.abdelmegid@zewailcity.edu.eg'),
(202300129, 'Nourhan Hassan', 'CIE', 2023, 's-nourhan.hassan@zewailcity.edu.eg'),
(202300275, 'Omar Samir', 'NANENG', 2023, 's-omar.samir@zewailcity.edu.eg'),
(202300387, 'Laila Mohamed', 'PEU', 2023, 's-laila.mohamed@zewailcity.edu.eg'),
(202300512, 'Sara Ahmed', 'BMS', 2023, 's-sara.ahmed@zewailcity.edu.eg'),
(202300621, 'Youssef Ali', 'CIE', 2023, 's-youssef.ali@zewailcity.edu.eg'),
(202300743, 'Amr Tarek', 'NANENG', 2023, 's-amr.tarek@zewailcity.edu.eg'),
(202300888, 'Salma Hesham', 'BMS', 2023, 's-salma.hesham@zewailcity.edu.eg'),
(202301004, 'Omar Mohamed', 'CIE', 2023, 's-omar.mohamed@zewailcity.edu.eg'),
(202301156, 'Nada Sami', 'BMS', 2023, 's-nada.sami@zewailcity.edu.eg'),
(202301287, 'Mohamed Hany', 'CIE', 2023, 's-mohamed.hany@zewailcity.edu.eg');
...
Insert into 
	instructor(Iname,ID,email)
values
	('Yasser ElAwady',105,'yelawady@zewailcity.edu.eg'),
	('Ashraf Hendam',302,'ahendam@zewailcity.edu.eg'),
	('Ahmed Hussein Khalil',454,'ahmkhalil@zewailcity.edu.eg'),
	('Mostafa ElShafei',505,'moelshafei@zewailcity.edu.eg'),
	('Tamer Ashour',404,'tali@zewailcity.edu.eg'),
	('Doaa Sakout',101,'delsakout@zewailcity.edu.eg'),
	('Waleed Abdelmeguid',103,'wabdelmagied@zewailcity.edu.eg'),
	('Abdallah AbouTahoun',108,'atahoun@zewailcity.edu.eg'),
	('Amr Mohamed',204,'amr@zewailcity.edu.eg'),
	('Hisham Anwer',666,'hisham.anwer@zewailcity.edu.eg'),
	('Maha Gouda',167,'mgouda@zewailcity.edu.eg'),
	('Mohamed Samir Eid',13,'mseid@zewailcity.edu.eg'),
	('Rabeay Younes Hassan',55,'ryounes@zewailcity.edu.eg'),
	('Tarek Ibrahim',303,'tibrahim@zewailcity.edu.eg'),
	('Mohamed Reyad Sakr',909,'mreyad@zewailcity.edu.eg');
...
VALUES
	...
	INSERT INTO assignment_submissions (Aname, ccode, sem, StID)
VALUES
   ('Intro to Classes', 'CIE 202', 'Spring 2024', 202200286),
   ('Stack and Queue', 'CIE 205', 'Spring 2024', 202200438),
   ('ER Diagram', 'CIE 206', 'Spring 2024', 202200126),
   ('PN Diode', 'CIE 212', 'Spring 2024', 202200102),
   ('Sinosouids', 'CIE 227', 'Spring 2024', 202200603),
   ('Differentiation', 'MTH 101', 'Fall 2023', 202100184),
   ('Polar Coordinates', 'MTH 102', 'Spring 2023', 202200477),
   ('Row Reduction', 'MTH 201', 'Fall 2024', 202201027),
   ('Linear ODE', 'MTH 202', 'Spring 2024', 202200647),
   ('Vectors', 'PHY 101', 'Fall 2023', 202200050),
   ('Columb Law', 'PHY 102', 'Spring 2023', 202300129),
   ('Waves', 'PHY 201', 'Fall 2024', 202300275),
   ('Special Relativity', 'PHY 202', 'Spring 2024', 202300387),
   ('Assignment 1', 'PEU 204', 'Spring 2023', 202300512),
   ('Assignment 1', 'PEU 205', 'Fall 2024', 202300621),
   ('Assignment 1', 'PEU 208', 'Spring 2024', 202300743),
   ('Essay 1', 'ENG 153', 'Spring 2023', 202301004),
   ('Logic Gates', 'CIE 239', 'Fall 2024', 202301156),
   ('Periodic Table', 'CHM 101', 'Fall 2023', 202301287);
...
SELECT r.ccode, r.sem, r.StID, NULL AS grade
FROM registered r;
...
values
	...
	('Introduction To Electrodynamics','PHY 102','https://libgen.rs/'),
